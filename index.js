...
function initOpenClosedBadge() {
  ...
  /* Operating Hours: 9 AM (9) to 2 AM (2) */
...
/* ---------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------- */
/* ✏️ UPDATED / LESSON: Added 4th promo slide for Harry Chocolate & Soft Packaged Loaf Bread */
const slides = [
  {
  ...
  {
    tag: "New Promo Drop",
    title: "Harry Chocolate & Fresh Daily Loaf Bread 🍞🍫",
    subtitle: "Indulge in rich Harry Chocolate drinks paired with soft, delicious packaged loaf bread!",
...
function updateHeroSlide(index) {
  ...
  if (heroTitle && heroSubtitle && heroSection) {
    if (heroTag && slides[index].tag) {
      heroTag.textContent = slides[index].tag;
    }
